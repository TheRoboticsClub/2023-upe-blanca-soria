...
class LauncherRosApi(ILauncher):
    ...
    def _set_environment(self):
        ...
        os.environ["GAZEBO_MODEL_PATH"] = f"{os.environ.get('GAZEBO_MODEL_PATH', '')}:{':/CustomRobots/CustomRobots/f1'}"
        #os.environ["GAZEBO_MODEL_PATH"] = f"{os.environ.get('GAZEBO_MODEL_PATH', '')}:{':/CustomRobots'.join(model_folders)}"
