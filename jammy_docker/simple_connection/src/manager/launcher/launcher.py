...
from src.manager.vnc.gui_view import Gui_view
...
class Launcher:
    ...
    def __init__(self, exercise):
        ...
        #self.gui_viewer = Gui_view(":3",5903,6082)


    def run(self):
        # TODO:
        # launching scenary, gazebo and rviz must be done with the configuration.json file.
